...
parser.add_argument('--train-file', default='data\\train.txt')
parser.add_argument('--dev-file', default='data\dev.txt')
parser.add_argument('--test-file', default='data\\test.txt')
...
parser.add_argument('--save-file', default='D:\python\TranslationTask\\transformer-simple\save\model.pt') # 模型保存位置
